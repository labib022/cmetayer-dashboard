...
const DEFAULTS = {
  heading: "Moving & Packing Services",
  description: "Easygoing moving, whether it's around the block or across the country, with expert packing to help you out.",
};

export default function MovingHeroSectionEditor() {
  ...
  const handleSave = async () => {
    setFeedback(null);
    try {
      await saveCmsPage({ page_name: "moving", section_name: "hero", content: form }).unwrap();
